/datum/foreign_realm/grenzelhoft
	...
	captain_last_names = list(
		"Faber", "Krummhorn", "Wolfsbein", "Hartwald", "von Eisenburg",
		"Eisenberg", "Falkenried", "Sturmwacht", "von Zentarion", "von Hochburg",
	) //TA EDIT
	ship_types = list(
		list("name" = "Coaster", "tonnage" = 30, "weight" = 15),
		list("name" = "Cog", "tonnage" = 120, "weight" = 50),
		list("name" = "Hulk", "tonnage" = 250, "weight" = 25),
		list("name" = "War Galleon", "tonnage" = 500, "weight" = 10),
	) //TA EDIT
	city_tags = list(
		"Stoneflake", "Eisenburg", "Aicecube", "Shpitze",
	...
	hail_lines = list(
		...
		"Grain from Goldfield, ingots from the foundries of Ironshard. Bring buyers, not browsers.",
		...
		"A registered magos of the Imperial Academy travels in my aft cabin. His papers are in order, his stipend is paid. Do not detain him; the Emperor's Magi take it personally.",
		...
		"A burgher of Zentarion rode with us this voyage and would not stop weeping and vomiting at the masthead. He has paid his fare. I make no apology for him.",
		...
		"Give me smoked eels by the barrel. Unjellied, please, that thing is an abomination upon humenity. I've heard the Imperial Academy's students have gotten tired of eating salmon everydaes. So eels from your river would be a nice change of pace."	
	)  //TA EDIT
