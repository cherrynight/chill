/datum/economic_region/kingsfield
	...
	description = "Kingsfield is a fortress city located on the coast to the south of the Twilight Axis. The city is surrounded by massive walls and possesses a small battery of gunpowder artillery, imported from Grenzelhoft and capable of firing over the entire area of the Azure Basin, thereby protecting the Duchy from military invasion by sea. This is also the site of the Duchy's main seaport, where refugees, adventurers, and other foreigners regularly arrive. The main force of the Ducial Royal Guard is also housed here, ensuring the safety of the coastal road — essentially the only land route connecting the Azurian Valley with the rest of the world."
